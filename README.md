...
💡 Business Insights
Sales performance varies significantly by country, with a small cluster of top countries contributing a disproportionately large share of total revenue.
Not every high-sales market is highly profitable — the Funnel chart reveals markets where profit lags well behind sales volume.
Product category rankings shift month-to-month, indicating seasonality in customer purchasing behavior across categories.
Certain quarters show sales growth without a corresponding rise in profit, pointing to potential discounting or cost-control issues.
Category-wise sales distribution shows an uneven mix, with one or two categories typically dominating overall revenue share.
Quantity sold does not always correlate with market size in revenue terms — some markets sell high volume at lower price points.
Shipping cost is not evenly distributed across customer segments, with one segment consistently more expensive to fulfill than others.
Year-over-year trends reveal whether growth is accelerating, plateauing, or declining, which is critical for forward planning.
Regional profit comparison highlights specific regions that consistently underperform relative to peers, warranting operational review.
Some regions show high profit despite modest sales volume, suggesting stronger margin discipline or product mix advantages.
Quarterly combo-chart analysis helps flag early-warning quarters where profit trends diverge from sales trends.
Segment-level shipping cost analysis can directly inform negotiations with logistics providers or shipping-mode policy changes.
The dashboard's slicer combination (Market + Region + Ship Mode + Quarter) enables root-cause analysis of localized performance dips.
Category and market-level insights together can guide inventory and stocking decisions for high-demand, high-margin product lines.
Overall, the dashboard demonstrates that sales volume and profitability are related but distinct stories — both must be tracked together for sound business decisions.
...
Data Collection — Sourced the Global Superstore Orders dataset
Data Cleaning — Handled inconsistencies and prepared fields in Power Query
Data Modeling — Built the Date Hierarchy and structured relationships for time intelligence
DAX Calculations — Authored KPI measures (Total Sales, Total Profit, Total Orders, Total Quantity)
Dashboard Design — Selected and configured 9 visuals plus 4 slicers on a single themed page
Business Insights — Translated visuals into actionable, stakeholder-ready findings
...
[Your Name] Aspiring Data Analyst | Power BI • SQL • Python 📧 [your-email@example.com] | 🔗 [LinkedIn Profile] | 💻 [GitHub Profile]
...
<details> <summary><strong>1. GitHub Repository Description (under 350 characters)</strong></summary>
...
</details> <details> <summary><strong>2. GitHub Topics/Tags (20)</strong></summary>
...
</details> <details> <summary><strong>3. LinkedIn Project Description (250–350 words)</strong></summary>
...
On the technical side, this project involved: 🔹 Data cleaning and transformation in Power Query 🔹 Data modeling with a Date Hierarchy for time intelligence 🔹 Writing DAX measures for all core KPIs 🔹 Selecting the right chart type for each business question 🔹 Designing a clean, recruiter-and-stakeholder-friendly single-page layout
...
</details> <details> <summary><strong>4. Resume Project Description (ATS-friendly, 4–5 bullets)</strong></summary>
...
</details> <details> <summary><strong>5. Portfolio Project Description (~200 words)</strong></summary>
